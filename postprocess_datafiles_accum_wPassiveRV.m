...
switch par.ERUconfig.outlet
    case 0
        title(['Mean Power Loss With Passive Ripple Control and ERU Feed Outlet Upstream of Valve: Ripple Control Valve Losses'],...
        'Interpreter','latex','FontSize',fontSize,'fontname','Times')
    case 1
        title(['Mean Power Loss With Passive Ripple Control and ERU Feed Outlet Downstream of Valve: Ripple Control Valve Losses'],...
        'Interpreter','latex','FontSize',fontSize,'fontname','Times')
end
...
switch par.ERUconfig.outlet
    case 0
        title(['Mean Power Loss With Passive Ripple Control and ERU Feed Outlet Upstream of Valve: PRV Losses'],...
        'Interpreter','latex','FontSize',fontSize,'fontname','Times')
    case 1
        title(['Mean Power Loss With Passive Ripple Control and ERU Feed Outlet Downstream of Valve: PRV Losses'],...
        'Interpreter','latex','FontSize',fontSize,'fontname','Times')
end
...
switch par.ERUconfig.outlet
    case 0
        title([varTitle,' With Passive Ripple Control and ERU Feed Outlet Upstream of Valve'],...
        'Interpreter','latex','FontSize',fontSize,'fontname','Times')
    case 1
        title([varTitle,' With Passive Ripple Control and ERU Feed Outlet Downstream of Valve'],...
        'Interpreter','latex','FontSize',fontSize,'fontname','Times')
end
