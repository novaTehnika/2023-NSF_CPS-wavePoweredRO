% study_refPTO_accum_wActiveRV_ERUupstream.m script m-file
% AUTHORS:
...
% a passive valve at the inlet to the RO module for managing pressure rate
% of change and with the ERU feed outlet presenting upstream of that valve.
%
...
%
% UPDATES:
% 7/6/2023 - Created from study_refPTO_accum_wActiveRV.m
%
...
% Save data
filename = ['data_refPTO_accum_wActiveRV_ERUupstream_', ...
